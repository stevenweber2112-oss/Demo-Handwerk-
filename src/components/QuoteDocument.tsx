...
/**
 * QuoteDocument – stellt das fertige Angebot als professionelles Dokument dar.
 *
 * Die Komponente ist rein darstellend: Sie bekommt ein fertiges `Quote`-Objekt
 * und rendert Kopf, Positionstabelle (gruppiert), Summen, Konditionen sowie die
 * Bedien-Buttons. Über "Als PDF drucken" wird `window.print()` ausgelöst – das
 * druckoptimierte CSS (siehe index.css) blendet dabei alles `.no-print` aus.
 */
...
const FIRMA = {
  name: 'Tischlerei Mustermann',
  inhaber: 'Inh. Max Mustermann',
  strasse: 'Werkstattweg 12',
  ...
  return (
    <div>
      ...
      <article className="print-document mx-auto max-w-4xl rounded-xl border border-slate-200 bg-white p-8 shadow-sm sm:p-12">
        ...
        {/* Empfänger-Platzhalter + Projektbeschreibung */}
        ...
        <p className="mb-6 text-sm leading-relaxed text-slate-600">
          Vielen Dank für Ihre Anfrage. Gerne unterbreiten wir Ihnen für das oben beschriebene
          Projekt das folgende Angebot:
        </p>

        {/* Positionstabelle, gruppiert */}
        ...
        <section className="mt-10 grid grid-cols-1 gap-x-8 gap-y-5 border-t border-slate-200 pt-8 text-sm sm:grid-cols-2">
          <Condition title="Ausführungsdauer">
            {quote.estimatedDuration} nach Auftragsbestätigung und Aufmaß
          </Condition>
        ...
        <footer className="mt-10 border-t border-slate-200 pt-6 text-sm leading-relaxed text-slate-600">
          <p>
            Über Ihren Auftrag würden wir uns sehr freuen. Bei Fragen stehen wir Ihnen gerne zur
            Verfügung.
          </p>
...
/** Ein Gruppen-Block in der Tabelle: Kopfzeile, Positionen, Zwischensumme. */
